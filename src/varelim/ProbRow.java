...
public class ProbRow {
     ...
     *
     * @param values, values of the variables (main variable+parents) in the row, of which the value of the main
     * variable itself is always first.
    ...
    public String toString() {
        ...
        valuesString.append(values.get(values.size() - 1));
