...
public class Main {
    ...
    private final static String networkName = "earthquake.bif"; // The network to be read in (format and other
    // networks can be found on http://www.bnlearn.com/bnrepository/)
    ...
    public static void main(String[] args) {
        ...
        Algorithm algorithm = new Algorithm(ui);
        algorithm.runElimination(query, vs, ps);
    }
}